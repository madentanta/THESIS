...
def augment_gaussian_noise(
    ...
    """
    Mandatory tabular data augmentation using Gaussian noise.
    Only applied to continuous features.
    """
    augmented = []
    ...
    for i in range(n_copies):
        ...
        noisy[continuous_cols] = noisy[continuous_cols] + noise
